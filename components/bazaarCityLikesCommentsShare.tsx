...
export const BazaarCityLikeCommentsShare = ({
  details,
  postType,
  refetchPost,
}: Props) => {
    ...
    >
      ...
      >
        <Mui.IconButton sx={{ p: 0 }}>
          {details?.likedBy === 1 ? (
            <Mui.Box width={20} sx={{mr:1}} component="img" src={LikedImage.src} />
          ) : (
            <Mui.Box width={20} sx={{mr:1}} component="img" src={LikeImage.src} />
          )}
        </Mui.IconButton>
        <Heading>
      ...
      <Mui.Stack direction={"row"} alignItems={"center"}>
        <Mui.IconButton sx={{ p: 0 }}>
          <Mui.Box width={20} sx={{mr:1}} component="img" src={CommentImage.src} />
        </Mui.IconButton>
        <Heading>
      ...
      >
        <Mui.IconButton sx={{ p: 0  }}>
          <Mui.Box width={20} sx={{mr:1}} component="img" src={ShareImage.src} />
        </Mui.IconButton>
